...
const checMinLength = (val, minLength, key)=>{
...
export default function(data){
    ...
    if(userName !== undefined){
        ...
        if(emptyValidationText !== ''){
            ...
            let minLengthValidation = checMinLength(userName, 3, 'userName')
    ...
    if(password !== undefined){
        ...
        if(emptyValidationText !== ''){
            ...
            let minLengthValidation = checMinLength(password, 2, 'password')
            if(minLengthValidation !== ''){
                return minLengthValidation;
            }
        }
